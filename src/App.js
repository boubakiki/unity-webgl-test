...
function App() {
	...
	useEffect(() => {
		if (innerWidth / innerHeight > 9.0 / 16.0) {
			setHeight(innerHeight);
			setWidth(innerHeight * (9.0 / 16.0));
			setMarginLeft((innerWidth - innerHeight * (9.0 / 16.0)) / 2.0);
			setMarginTop(0);
		} else if (innerWidth / innerHeight < 9.0 / 16.0) {
			setWidth(innerWidth);
			setHeight(innerWidth * (16.0 / 9.0));
			setMarginTop((innerHeight - innerWidth * (16.0 / 9.0)) / 2.0);
			setMarginLeft(0);
		} else {
			setWidth(innerWidth);
			setHeight(innerHeight);
